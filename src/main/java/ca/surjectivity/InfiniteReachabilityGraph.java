...
public class InfiniteReachabilityGraph {
    ...
    private static Map<ITNode, ITNode[]> edges;

    private static Map<ITNode, MutableNode> nodeTable;
    ...
    private static void draw(final String r, MutableGraph graph) {
        ...
        ITNode root = ITNode.getRootNode(diameter - 1, RULE);
